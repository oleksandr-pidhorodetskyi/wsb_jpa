INSERT INTO PATIENT (
    id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, active
      ...
      (103, 'Tomasz', 'Zieliński', '111111111', 'tomasz.zielinski@email.com', 'P125', '1975-03-20', false),
      (104, 'Ewa', 'Kowalska', '222222222', 'ewa.kowalska@email.com', 'P126', '1990-12-01', true),
      (105, 'Marek', 'Nowak', '333333333', 'marek.nowak@email.com', 'P127', '1985-07-11', true),
      (106, 'Julia', 'Wiśniewska', '444444444', 'julia.wisniewska@email.com', 'P128', '1988-04-30', false);
